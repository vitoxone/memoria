          ...
          <div class="panel-tab"> 
            ...
            <div class="form-group">
                ...
                <div class="col-lg-4 input-group">
                  <?php echo $this->Form->input('Collaborator.name', array('class' => 'form-control', 'label'=>'', 'type' => 'text','autofocus' => 'autofocus', 'id' => 'name')); ?>
                ...
                <div class="col-lg-4 input-group">
                  <?php echo $this->Form->input('Collaborator.rut', array('class' => 'form-control', 'label'=>'', 'type' => 'text', 'id' => 'rut')); ?>
                ...
                <div class="col-lg-4 input-group">
                  <?php echo $this->Form->input('Collaborator.email', array('class' => 'form-control', 'label'=>'', 'type' => 'text', 'id' => 'email')); ?>
...
?>
                ...
                <div class="col-lg-6 input-group">
                  <?php echo $this->Form->input('Collaborator.birthdate',
     array('label'=>'',
     'type' => 'date',
    'dateFormat' => 'DMY',
    'monthNames' => $meses,
        ...
        'maxYear' => date('Y') - 16 )); ?>
                ...
                <div class="col-lg-4 input-group">
                  <?php echo $this->Form->input('Collaborator.gender_id', array('class' => 'form-control', 'label'=>'', 'id' => 'gender')); ?>
