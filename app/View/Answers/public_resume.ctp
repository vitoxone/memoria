...
<div id="landing-container">
			...
			<div class="padding-md">
				<div class="row">
					...
					<div class="col-xs-6 col-sm-12 col-md-6">
							<div class="normal-container shortcut-wrapper">
							<a href="#" class="shortcut-link">
								<span class="shortcut-icon">
									<?php echo $this->Html->image('/img/eye.png',array('class' => 'img-like')); ?>
								</span>
								<label class="text" id = "view"><?php echo $user['User']['views'] ?></label>
							</a>
							<a href="#" class="shortcut-link">
								<span class="shortcut-icon">
							<?php echo $this->Html->image('/img/heart1.png',array('id'=>'like', 'class' => 'img-like')); ?>							
								</span>
								
								<label class="text" id = "likes"><?php echo $user['User']['likes'] ?></label>
							</a>
...
<!--<a href="javascript:fbShare('http://www.curicochile.cl', 'Fb Share', 'Descubre tu estilo de aprendizaje aquí', 'http://goo.gl/dS52U', 520, 350)">Share</a>-->
							...
							<div id="chartdiv" style="width:510px; height:500px;"></div>
    ...
    document.getElementById("like").onclick=function()
			{
			 $('#likes').val(1);                
		        jQuery.ajax({
		            ...
		            cache: false,
			    dataType:'json',
		            url: '<?php echo Router::Url(array('controller' => 'users','admin' => FALSE, 'action' => 'addLike', $user['User']['id']),TRUE, 172); ?>',
		            success: function(response) {
		               var actual = parseInt($('#likes').text());
			       $('#likes').text(actual + 1);
		            }
