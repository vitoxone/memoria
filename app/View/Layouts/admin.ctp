...
<html lang="en">
  <head>
	...
	<!-- Endless -->
	<link href="/vocacion/css/endless.min.css" rel="stylesheet">
	<link href="/vocacion/css/endless-skin.css" rel="stylesheet">
  ...
  <body class="overflow-hidden">
	...
	<div id="wrapper" class="preload">
			...
			<ul class="nav-notification clearfix">
				...
				<li class="profile dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li><a tabindex="-1" href="http://localhost/vocacion/users/logout" class="main-link"><i class="fa fa-lock fa-lg"></i> Salir</a></li>
					</ul>
				</li>
			</ul>
		</div><!-- /top-nav-->
		...
		<aside class="skin-2 fixed">
			<div class="brand">
				<span>Vocación</span>
				<span class="text-toggle"> Utalca</span>
			</div><!-- /brand -->					
			<div class="sidebar-inner">
				<div class="size-toggle">
					...
					<a >
					<a class="btn btn-sm pull-right" href="http://localhost/vocacion/users/logout">
				...
				<div class="user-block clearfix">
					<img src="img/user.jpg" alt="User Avatar">
					<div class="detail">
						<strong><?php echo AuthComponent::user('name') ?></strong><span class="badge badge-danger bounceIn animation-delay4 m-left-xs">4</span>
				...
				<div class="main-menu">
					<ul>
						<li>
							<a href="http://localhost/vocacion/admin/questions/index">
								<span class="menu-icon">
									<i class="fa   fa-camera fa-lg"></i> 
								</span>
								<span class="text">
									<a<?php echo $this->Html->link('Prueba', array('controller' => 'questions', 'action' => 'index', 'class'=>'text')); ?></a>
								</span>
								<span class="menu-hover"></span>
							</a>
							<ul class="dropdown-menu">
								<li>
									<a <?php echo $this->Html->link('Ver Preguntas', array('controller' => 'questions', 'action' => 'index', 'class'=>'text')); ?> </a>
									
								</li>
								<li>
									<a <?php echo $this->Html->link('Agregar Pregunta', array('controller' => 'questions', 'action' => 'add', 'class'=>'text')); ?> </a>
									
								</li>
							</ul>
						</li>
						<li>
							<a href="http://localhost/vocacion/admin/careers/index">
								<span class="menu-icon">
									<i class="fa fa-road fa-lg"></i> 
								</span>
								<span class="text">
									<a<?php echo $this->Html->link('Carreras', array('controller' => 'careers', 'action' => 'index', 'class'=>'text')); ?></a>
								</span>
								<span class="menu-hover"></span>
							</a>
							<ul class="dropdown-menu">
								<li>
									<a <?php echo $this->Html->link('Ver Carreras', array('controller' => 'careers', 'action' => 'index', 'class'=>'text')); ?> </a>
									
								</li>
								<li>
									<a <?php echo $this->Html->link('Agregar Carrera', array('controller' => 'careers', 'action' => 'add', 'class'=>'text')); ?> </a>
									
								</li>
							</ul>
						</li>
									<li>
							<a href="http://localhost/vocacion/admin/answers/index">
								<span class="menu-icon">
									<i class="fa   fa-camera fa-lg"></i> 
								</span>
								<span class="text">
									<a<?php echo $this->Html->link('Respuestas', array('controller' => 'answers', 'action' => 'index', 'class'=>'text')); ?></a>
								</span>
								<span class="menu-hover"></span>
							</a>
						</li>
						<li>
							<a href="http://localhost/vocacion/admin/careers/calculos">
								<span class="menu-icon">
									<i class="fa   fa-camera fa-lg"></i> 
								</span>
								<span class="text">
									<a<?php echo $this->Html->link('Cálculos', array('controller' => 'careers', 'action' => 'calculos', 'class'=>'text')); ?></a>
								</span>
								<span class="menu-hover"></span>
							</a>
						</li>
					...
					-->
						<li>
							<a href="http://localhost/vocacion/admin/users/index">
								<span class="menu-icon">
